...
class NoElement(DrawingElement):
    ...
    def write_svg_element(self, id_map, is_duplicate, output_file, dry_run, lcontext, force_dup=...): # -> None:
        ...
...
class Text(DrawingParentElement):
    ...
    TAG_NAME = ...
    has_content = ...
    def __new__(cls, text, *args, path=..., id=..., _skip_check=..., **kwargs): # -> Group | Self@Text:
        ...
    
    def __init__(self, text, font_size, x=..., y=..., *, center=..., line_height=..., line_offset=..., path=..., start_offset=..., path_args=..., tspan_args=..., cairo_fix=..., _skip_check=..., **kwargs) -> None:
        ...
...
class Path(DrawingBasicElement):
    ...
    def arc(self, cx, cy, r, start_deg, end_deg, cw=..., include_m=..., include_l=...): # -> Self@Path:
