...
class SyncedAnimationConfig:
    ...
    controls_draw_function: Callable[[
        SyncedAnimationConfig, bool], Group] = ...
...
class AnimatedAttributeTimeline:
    ...
    # -> Animate:
    def as_animate_element(self, config: Optional[SyncedAnimationConfig] = ...):
        ...
...
# -> None:
def animate_text_sequence(container, times: List[float], values: List[str], *text_args, kwargs_list=..., **text_kwargs):
